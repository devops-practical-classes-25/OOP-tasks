...
Для выполнения задания нужно в необходимых файлах заменить исключения на код для реализации. В папке `OopShapesProject` вы найдете файлы `Shape`, `Circle` и `Rectangle`. Корректность работы программы необходимо проверить при помощи тестов из папки `OopShapesProject.Tests`, файл `ShapeTests.cs`. Для запуска тестов выполните ``` dotnet test ```
